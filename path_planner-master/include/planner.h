...
class Planner {
  ...
  */
  void setMap( nav_msgs::OccupancyGrid::Ptr map);
  void update_cost_map( nav_msgs::OccupancyGrid::Ptr map);
  /*!
     \brief setStart
 ...
 private:
  ...
  ros::Publisher pubStart,path_planned_pub;
  std_msgs::Bool path_planned;
  /// A subscriber for receiving map updates
  ros::Subscriber subMap,subMap_cost;
  ...
  nav_msgs::OccupancyGrid::Ptr grid,cost_map;
