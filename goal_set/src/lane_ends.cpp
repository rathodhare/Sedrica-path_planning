...
double des_lat[co_number] = {19.1294746417};//{ 19.1251380983};//{19.1259112833};////{19.1296389633};//{19.1294204367};//{19.1295804183};    //Define Required GPS location //gate 19.1295974467
double des_lon[co_number] = {72.9171582767};//{72.9159026833};//{72.9155033633};//{72.9155408533};////{72.9172522317};//{72.91613313}; // gate 72.9173579667
double des_xpos=0;
double des_ypos=0;
